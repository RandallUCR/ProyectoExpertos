		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-8" style="margin-rigth:50px;">
						<h1 style="color: #06408C">Destino</h1><br>
				...
				<div class="col-lg-3" style="margin-left:50px;">
					<h1 style="color: #06408C">Galería</h1>
					<h6 style="color: #06408C">Haz click en la imagen para ver más imagenes y un video del destino</h6>
			...
			<div>
				...
				<h1 style="color: #06408C">Ubicación</h1><br>
				<p style="font-size: 20px; text-align:justify">
...
<div id="myModal" class="modal fade" role="dialog" >
  	<div class="modal-dialog modal-lg " >
		...
		<!-- Modal content-->
		<div class="modal-content" style="background-color: #0b55b575">
